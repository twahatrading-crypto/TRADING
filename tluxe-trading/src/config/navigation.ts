import { HEATMAP_ROUTE, HLE_ROUTE, HLR_ROUTE, LIQUIDITY_ROUTE, NEWS_ROUTE, ORDER_BLOCKS_ROUTE, SMC_ROUTE, SR_ROUTE } from './modules';
 ...
 */
export type StrategyIcon = 'sr' | 'liquidity' | 'orderBlocks' | 'hlr' | 'hle' | 'heatmap' | 'smc' | 'news' | 'sweep';
