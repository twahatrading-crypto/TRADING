...
const PAGES = ['/#/', '/#/engines/support-resistance', '/#/engines/liquidity', '/#/engines/order-blocks', '/#/engines/high-low-reversal', '/#/engines/high-low-engine', '/#/engines/liquidity-heatmap', '/#/engines/smc', '/#/settings'];
